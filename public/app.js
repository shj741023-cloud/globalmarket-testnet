...
async function openTradeDetail(tradeId) {
  ...
  const refundSection = detail.refund ? `<div class="detail-grid"><p><small>Testnet 환불상태</small><strong>전액 모의환불 완료</strong></p><p><small>구매자 모의환불액</small><strong>${escapeHtml(detail.refund.totalBuyerRefund)} Test-Pi</strong></p></div>` : '';
